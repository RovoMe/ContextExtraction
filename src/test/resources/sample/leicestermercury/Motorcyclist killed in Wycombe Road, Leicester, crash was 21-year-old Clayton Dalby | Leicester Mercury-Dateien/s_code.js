...
s.linkInternalFilters="javascript:," + document.location.hostname;
s.linkLeaveQueryString=false
s.linkTrackVars="None"
s.linkTrackEvents="None"

s._channelDomain="A&N Media Known Referrals|dailymail.co.uk,thisismoney.co.uk,jobsite.co.uk,findaproperty.com,findanewhome.com,primelocation.com,teletext.co.uk,loopylove.com,datingforparents.com,girlsdateforfree.com,localpeople.co.uk,thisishullandeastriding.co.uk,thisisgrimsby.co.uk,thisisscunthorpe.co.uk,thisislincolnshire.co.uk,thisisretford.co.uk,thisisboston.co.uk,thisithesentinel.co.uk,thisisstaffordshire.co.uk,thisisleek.co.uk,thisisuttoxeter.co.uk,thisischeadle.co.uk,thisisleicestershire.co.uk,thisisderbyshire.co.uk,thisisnottingham.co.uk,thisistamworth.co.uk,thisislichfield.co.uk,thisissuttoncoldfield.co.uk,thisiswalsallonline.co.uk,thisissouthwales.co.uk,thisisbristol.co.uk,thisiswesterndailypress.co.uk,thisisgloucestershire.co.uk,thisisbath.co.uk,thisissomerset.co.uk,thisisdevon.co.uk,thisisplymouth.co.uk,thisisexeter.co.uk,thisissouthdevon.co.uk,thisiscornwall.co.uk,thisisnorthdevon.co.uk,westgaz.co.uk,thisiscourier.co.uk,thisiskent.co.uk,thisiscroydontoday.co.uk,thisissurreytoday.co.uk,thisissussex.co.uk,thisistotalessex.co.uk,thisisdorset.co.uk,southwestbusiness.co.uk,thisisfootball.co.uk,thisisbusiness-eastmidlands.co.uk,businessinthebay.co.uk,thisisbusiness-staffordshire.co.uk,therams.co.uk,bygonederbyshire.co.uk,thebluearmy.co.uk,riders.westerndailypress.co.uk,holdthefrontpage.co.uk,motors.co.uk,globrix.com,thisislondon.co.uk,teletext.co.uk,thisismoney.co.uk,metro.co.uk,people.co.uk,newsnow.co.uk>Email|mail.google.com,hotmail.com,gmail.com,googlemail.com>Social Network Sites Natural|facebook.com,twitter.com,digg.com,linkedin.com,myspace.com,youtube.com"
s._channelPattern="Email|email>Search Engines Paid|ppc"
...
function s_doPlugins(s) {
	...
	s.channelManager('ito','','s_campaign',0,"s_dl");
	
	//console.log("Check channel");
	//console.log(s._channel)
	//console.log("Done");
	
	if(s._channel=="Paid Search"){
		s._channel="Search Engines Paid"
	}
	
	s.campaign=s._campaign;
	s.prop14=s._channel;
	if (s._campaign) s._campaign = s._campaign.toLowerCase();

	if (s._referringDomain)
	{
		if(s._channel=="Search Engines Paid")
		{
			if (s._referringDomain.indexOf("google")>-1)
			{
				s.prop18="Google PPC";
				if(s._campaign=="gbrand"){
					s.prop20="Google PPC Brand";
				}
				else if(s._campaign=="gcomm"){
					s.prop20="Google PPC Community";
				}
				else if(s._campaign=="gent"){
					s.prop20="Google PPC Entertainment";
				}
				else if(s._campaign=="ggen"){
					s.prop20="Google PPC General";
				}
				else if(s._campaign=="gnews"){
					s.prop20="Google PPC News";
				}
				else if(s._campaign=="gsport"){
					s.prop20="Google PPC Sport";
				}
				else if(s._campaign=="gimage"){
					s.prop20="Google PPC Image";
				}
			}
			else if (s._referringDomain.indexOf("msn")>-1){
				s.prop18="MSN PPC";
				if(s._campaign=="mbrand"){
					s.prop20="MSN PPC Braad";
				}
				else if(s._campaign=="mcomm"){
					s.prop20="MSN PPC Community";
				}
				else if(s._campaign=="ment"){
					s.prop20="MSN PPC Entertainment";
				}
				else if(s._campaign=="mgen"){
					s.prop20="MSN PPC General";
				}
				else if(s._campaign=="mnews"){
					s.prop20="MSN PPC News";
				}
				else if(s._campaign=="msport"){
					s.prop20="MSN PPC Sport";
				}				
			}
			else if (s._referringDomain.indexOf("yahoo")>-1){
				s.prop18="Yahoo PPC";
				if(s._campaign=="ybrand"){
					s.prop20="Yahoo PPC Brand";
				}
				else if(s._campaign=="ycomm"){
					s.prop20="Yahoo PPC Community";
				}
				else if(s._campaign=="yent"){
					s.prop20="Yahoo PPC Entertainment";
				}
				else if(s._campaign=="ygen"){
					s.prop20="Yahoo PPC General";
				}
				else if(s._campaign=="ynews"){
					s.prop20="Yahoo PPC News";
				}
				else if(s._campaign=="ysport"){
					s.prop20="Yahoo PPC Sport";
				}
			}
		}
		else if(s._channel=="A&N Media Known Referrals"){
			if(s._referringDomain.indexOf("dailymail.co.uk")>-1 || s._referringDomain.indexOf("thisismoney.co.uk")>-1){
				s.prop18="DMGT - DailyMail";
			}
			else if(s._referringDomain.indexOf("jobsite.co.uk")>-1){
				s.prop18="DMGT - Jobsite";
			}
			else if(s._referringDomain.indexOf("findaproperty.com")>-1 || s._referringDomain.indexOf("findanewhome.com")>-1){
				s.prop18="DMGT - Property";
			}
			else if(s._referringDomain.indexOf("primelocation.com")>-1){
				s.prop18="Primelocation";
			}
			else if(s._referringDomain.indexOf("teletext.co.uk")>-1){
				s.prop18="DMGT - Teletext";
			}
			else if(s._referringDomain.indexOf("loopylove.com")>-1 || s._referringDomain.indexOf("datingforparents.com")>-1 || s._referringDomain.indexOf("girlsdateforfree.com")>-1){
				s.prop18="Allegran";
			}
			else if(s._referringDomain.indexOf("localpeople.co.uk")>-1){
				s.prop18="Local People Network Site";
			}
			else if(s._referringDomain.indexOf("newsnow.co.uk")>-1){
				s.prop18="News Now";
			}
			else if(s._referringDomain.indexOf("thisishullandeastriding.co.uk")>-1 || s._referringDomain.indexOf("thisisgrimsby.co.uk")>-1 || s._referringDomain.indexOf("thisisscunthorpe.co.uk")>-1 || s._referringDomain.indexOf("thisislincolnshire.co.uk")>-1 || s._referringDomain.indexOf("thisisretford.co.uk")>-1 || s._referringDomain.indexOf("thisisboston.co.uk")>-1 || s._referringDomain.indexOf("thisithesentinel.co.uk")>-1 || s._referringDomain.indexOf("thisisstaffordshire.co.uk")>-1 || s._referringDomain.indexOf("thisisleek.co.uk")>-1 || s._referringDomain.indexOf("thisisuttoxeter.co.uk")>-1 || s._referringDomain.indexOf("thisischeadle.co.uk")>-1 || s._referringDomain.indexOf("thisisleicestershire.co.uk")>-1 || s._referringDomain.indexOf("thisisderbyshire.co.uk")>-1 || s._referringDomain.indexOf("thisisnottingham.co.uk")>-1 || s._referringDomain.indexOf("thisistamworth.co.uk")>-1 || s._referringDomain.indexOf("thisislichfield.co.uk")>-1 || s._referringDomain.indexOf("thisissuttoncoldfield.co.uk")>-1 || s._referringDomain.indexOf("thisiswalsallonline.co.uk")>-1 || s._referringDomain.indexOf("thisissouthwales.co.uk")>-1 || s._referringDomain.indexOf("thisisbristol.co.uk")>-1 || s._referringDomain.indexOf("thisiswesterndailypress.co.uk")>-1 || s._referringDomain.indexOf("thisisgloucestershire.co.uk")>-1 || s._referringDomain.indexOf("thisisbath.co.uk")>-1 || s._referringDomain.indexOf("thisissomerset.co.uk")>-1 || s._referringDomain.indexOf("thisisdevon.co.uk")>-1 || s._referringDomain.indexOf("thisisplymouth.co.uk")>-1 || s._referringDomain.indexOf("thisisexeter.co.uk")>-1 || s._referringDomain.indexOf("thisissouthdevon.co.uk")>-1 || s._referringDomain.indexOf("thisiscornwall.co.uk")>-1 || s._referringDomain.indexOf("thisisnorthdevon.co.uk")>-1 || s._referringDomain.indexOf("westgaz.co.uk")>-1 || s._referringDomain.indexOf("thisiscourier.co.uk")>-1 || s._referringDomain.indexOf("thisiskent.co.uk")>-1 || s._referringDomain.indexOf("thisiscroydontoday.co.uk")>-1 || s._referringDomain.indexOf("thisissurreytoday.co.uk")>-1 || s._referringDomain.indexOf("thisissussex.co.uk")>-1 || s._referringDomain.indexOf("thisistotalessex.co.uk")>-1 || s._referringDomain.indexOf("thisisdorset.co.uk")>-1 || s._referringDomain.indexOf("southwestbusiness.co.uk")>-1 || s._referringDomain.indexOf("thisisfootball.co.uk")>-1 || s._referringDomain.indexOf("thisisbusiness-eastmidlands.co.uk")>-1 || s._referringDomain.indexOf("businessinthebay.co.uk")>-1 || s._referringDomain.indexOf("thisisbusiness-staffordshire.co.uk")>-1 || s._referringDomain.indexOf("therams.co.uk")>-1 || s._referringDomain.indexOf("bygonederbyshire.co.uk")>-1 || s._referringDomain.indexOf("thebluearmy.co.uk")>-1 || s._referringDomain.indexOf("riders.westerndailypress.co.uk")>-1) {
				s.prop18="This Is Network";
			}
		}
		else if (s._channel="Social Network Sites Natural"){
			if(s._referringDomain.indexOf("twitter.com")>-1){
				s.prop18="Twitter";
			}
			else if(s._referringDomain.indexOf("facebook.com")>-1){
				s.prop18="Facebook fan page";
			}
		}
	}
	
	if (s._campaign && s._campaign.indexOf("ppc-gofind")>-1)
	{
		s.prop18="Directory";
	}
		
	if(!s.eVar13)
	s.eVar13=s.getQueryParam('pid')
...
if(s.prop11&&!s.eVar32) s.eVar32=s.prop11;
...
/*
 * channelManager v2.4 - Tracking External Traffic (Customized)
 */
...
+"indexOf(Y);if(H>-1)P=q[0]}}}if(X)M=M?M:'n/a';p=X&&p?p:'';t=X&&t?t:'"
...
s.visitorNamespace="associatednorthcliffedigital";
s.trackingServer="wa.northcliffedigital.co.uk";
s.trackingServerSecure="swa.northcliffedigital.co.uk";
s.visitorMigrationKey="50E94837";
s.visitorMigrationServer="wa.and.co.uk";
s.visitorMigrationServerSecure="swa.and.co.uk";
