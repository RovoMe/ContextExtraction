...
if (typeof janrain.settings.common.appUrl === 'undefined')janrain.settings.common.appUrl = "https://login.johnstonpress.co.uk";
...
if (typeof janrain.settings.format === 'undefined')janrain.settings.format = "one row";
if (typeof janrain.settings.width === 'undefined')janrain.settings.width = "252";
if (typeof janrain.settings.providersPerPage === 'undefined')janrain.settings.providersPerPage = "7";
...
if (typeof janrain.settings.appId === 'undefined')janrain.settings.appId = "feohdolkfcacnajicemo";
if (typeof janrain.settings.appUrl === 'undefined')janrain.settings.appUrl = "https://login.johnstonpress.co.uk";
...
if (typeof janrain.settings.facebookAppId === 'undefined')janrain.settings.facebookAppId = "477485819060164";
...
if (typeof janrain.settings.share.appUrl === 'undefined')janrain.settings.share.appUrl = "https://login.johnstonpress.co.uk";
...
function getPackagePath(packages) {
    ...
    var path = rootPath + 'manifest/' + packages.join(':') + '?version=' + encodeURIComponent('1.109.0_widgets_494');
    return path;
}
