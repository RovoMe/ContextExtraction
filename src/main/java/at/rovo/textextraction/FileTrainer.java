...
/**
 * Is a concrete implementation of a {@link TrainingDataStrategy} which loads data from text files located in the
 * <code>trainingDir</code> directory specified in the constructor.
 */
public class FileTrainer extends AbstractTrainer
{
    ...
    public Classifier<String, String> trainModel(Classifier<String, String> classifier, boolean... retrain)
    {
        ...
        if (_retrain || !this.isCommonTagsAvailable())
        {
            ...
            classifier.saveData(trainingDir,
                                "mssClassificationData" + "_" + trainingSampleSize + "_" + trainFeatureStrategy.name() +
                                ".ser");
